 ...
 */
package com.lisasoft.wsfacade.wfs.mappers;
...
import com.lisasoft.wsfacade.wfs.models.GetFeatureInfoModel;
import com.lisasoft.wsfacade.wfs.models.GetFeatureInfoResponseModel;
import com.lisasoft.wsfacade.wfs.models.GetTileModel;
import com.lisasoft.wsfacade.wfs.models.GetTileResponseModel;

public class WfsSoapMapper extends SoapMapper {

	static final Logger log = Logger.getLogger(WfsSoapMapper.class);
	
	protected WfsSoapMapper() {
		super(null);
	}
	
	protected WfsSoapMapper(String startTag) {
		super(startTag);
	}
